...
[-] После перетаскивания на окно MMArchive открытого в данный момент архива, список файлов переставал обновляться при произведении операций",
	...
	{
		Date = "2018-07-06T23:35:46Z",
		Desc = "[+] Borderless full screen mode (the game runs in your standard resolution, stretched to full screen with black borders as needed).\
...
[+] Поддержка полноцветного (32 бита) режима.\
[+] Свои архивы SND и VID. Работают точно так же, как архивы LOD.\
[+] Предметы теперь располагаются в инвентаре вертикально, как в MM7 и MM8.\
...
[-] Множество исправлений в коде игры и на картах. Я, наконец-то, занялся картами и исправил все ошибки, которые нашёл.",
		...
		MirrorSF = {
			...
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.1/MM6 Patch Buka v2.1.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.1/MM6 Patch Loc v2.1.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.1/MM6Patch ReadMe.TXT/download",
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.1/MM6Patch ReadMe_rus.TXT/download"
		},
		Title = "MM6Patch v2.1"
	},
	{
		Date = "2018-07-06T23:48:49Z",
...
[-] Множество исправлений в коде игры и на картах. Я, наконец-то, занялся картами и исправил все ошибки, которые нашёл.",
		...
		MirrorSF = {
			...
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.1/MM7 Patch Buka v2.1.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.1/MM7 Patch Loc v2.1.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.1/MM7Patch ReadMe.TXT/download",
...
[+] Уровень приближения миникарты теперь запоминается всегда, а не только на внешних картах, как раньше.\
[+] Теперь можно выбирать неактивных персонажей, но нельзя использовать.\
[-] Исправлены некоторые косметические баги интерфейса.\
[-] Статические спрайты (например, бочки) показывались сжатыми по вертикали в помещениях в режиме аппаратного ускорения.\
[-] Неактивные персонажи не могли пользоваться сундуками.\
[+] И более мелкие изменения...\
",
		Files = {
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.2/MM7.Patch.v2.2.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.2/MM7.Patch.Buka.v2.2.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.2/MM7.Patch.Loc.v2.2.exe"
		},
		Id = "MM7Patch-2.2",
		MirrorSF = {
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.2/MM7 Patch v2.2.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.2/MM7 Patch Buka v2.2.exe/download",
...
[+] Размер спрайтов корректируется в зависимости от угла наклона. Так они ведут себя реалистичнее, особенно при взгляде вверх на высоких монстров.\
[+] Теперь в режиме программной отрисовки взрывы не мешают выбору цели.\
[+] Когда NoIntro=1, вступительный видеоролик показывается при старте новой игры.\
[+] UI.txt: Опция ShrinkStatusbar - размер строки состояния подстраивается под размер текста в ней.\
[+] Опция TreeHints управляет показом подсказок для деревьев, цветов и т.п.\
[-] Гранд топора не уменьшал браню врагов вдвое.\
[-] Мой/DirectX баг: Игра не могла стартовать в разрешениях более 1080p, т.к. Direct3D 7 их не поддерживает.\
[+] И изменения поменьше...",
		Files = {
			"https://github.com/GrayFace/Misc/releases/download/MM8Patch-2.4/MM8.Patch.v2.4.exe"
		},
		Id = "MM8Patch-2.4",
		MirrorSF = {
...
[+] В инвентаре неидентифицированные предметы теперь показываются зелёнымы пока нажата правая кнопка мыши.\
...
[+] И другие изменения...",
		Files = {
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5/MM7.Patch.v2.5.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5/MM7.Patch.Buka.v2.5.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5/MM7.Patch.Loc.v2.5.exe"
		},
		Id = "MM7Patch-2.5",
		MirrorSF = {
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5/MM7 Patch v2.5.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5/MM7 Patch Buka v2.5.exe/download",
...
[*] ????? \"FixUnmarkedArtifacts\" ?????? ????????? ????? ? 13 ????????? ??????????, ??????????????? ?????.",
		Files = {
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5.5/MM7.Patch.v2.5.5.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5.5/MM7.Patch.Buka.v2.5.5.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5.5/MM7.Patch.Loc.v2.5.5.exe"
		},
		Id = "MM7Patch-2.5.5",
		MirrorSF = {
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5.5/MM7 Patch v2.5.5.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5.5/MM7 Patch Buka v2.5.5.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5.5/MM7 Patch Loc v2.5.5.exe/download"
		},
		Title = "MM7Patch v2.5.5"
	},
	{
		Date = "2022-01-13T21:06:36Z",
		Desc = "[-] My bug: A bug when taking an item from character's inventory that could lead to immunities corruption in MM8.\
[-] My bug: FixChests option got broken by 2.5.4 changes.\
[*] FixUnmarkedArtifacts option now also respects the 13 artifacts limit imposed by the game.",
		DescRU = "[-] Мой баг: Баг при взятии предмета из инвентаря, который мог приводить к повреждению данных об иммунитетах персонажа в MM8.\
...
[-] ??????? (d13): +5 ???? ???? ?? ???????? ???????? ? ???????, ??????? ???????? ?????????.",
		Files = {
			"https://github.com/GrayFace/Misc/releases/download/MM6Patch-2.5.6/MM6.Patch.v2.5.6.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM6Patch-2.5.6/MM6.Patch.Buka.v2.5.6.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM6Patch-2.5.6/MM6.Patch.Loc.v2.5.6.exe"
		},
		Id = "MM6Patch-2.5.6",
		MirrorSF = {
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.5.6/MM6 Patch v2.5.6.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.5.6/MM6 Patch Buka v2.5.6.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM6Patch/v2.5.6/MM6 Patch Loc v2.5.6.exe/download"
		},
		Title = "MM6Patch v2.5.6"
	},
	{
		Date = "2022-02-05T13:16:04Z",
		Desc = "[-] Items laying on the ground in one map were appearing in another when traveling by foot sometimes.\
[-] My bug: DisableHooks option wasn't working for some new hooks.\
[-] My bug: When custom *.games.lod archives are used, incorrect data was written to autosave on New Game start. It was fully inconsequential until version 2.5.4.\
[-] Fixes in maps: Duplicated chests and houses, possibility of generation of artifacts in chests that can't be opened etc.\
...
[-] Исправления на картах: Дублированные сундуки и дома, возможность генерации артефактов в недоступных сундуках и т.д.\
[-] Монолит (d13): +5 Силы духа не давалось клерикам и друидам, которые получили повышение.",
		Files = {
			"https://github.com/GrayFace/Misc/releases/download/MM6Patch-2.5.6/MM6.Patch.v2.5.6.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM6Patch-2.5.6/MM6.Patch.Buka.v2.5.6.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM6Patch-2.5.6/MM6.Patch.Loc.v2.5.6.exe"
...
[-] Мой баг: Исправление Всплеска кислоты, меняющее элемент заклинания с Физического на Воду, делало это даже когда он явно указан физическим в spells.txt. Теперь исправление также можно отключить, добавив FixAcidBurst=0 в INI.",
		Files = {
			...
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5.7/MM7.Patch.Buka.v2.5.7.exe",
			"https://github.com/GrayFace/Misc/releases/download/MM7Patch-2.5.7/MM7.Patch.Loc.v2.5.7.exe"
		},
		Id = "MM7Patch-2.5.7",
		MirrorSF = {
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5.7/MM7 Patch v2.5.7.exe/download",
			"https://sourceforge.net/projects/grayface/files/MM7Patch/v2.5.7/MM7 Patch Buka v2.5.7.exe/download",
